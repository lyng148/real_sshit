...
public class Group extends BaseEntity {
    ...
    @Pattern(regexp = "^https://github\\.com/[^/]+/[^/]+$",
            message = "Invalid GitHub repository URL format. Must be like: https://github.com/username/repository or git@github.com:username/repository.git://github.com/username/repository or git@github.com:username/repository.git")
